...
public class DatasForDB {
    ...
    // Созвездия
    //
    public String[] constellationName = {"Персей", "Лев", "Андромеда", "Большая Медведица", "Овен", "Цефей", "Дельфин", "Змееносец", "Кит"};
    public int[] constelletionId = {       151,     152,       153,            154,           155,    156,      157,         158,     159};
    public String[] constellationImg = {"constellation_persei", "constellation_lev", "constellation_andromeda", "constellation_bolshaya_medved", "constellation_oven", "constellation_cefer", "constellation_delphin", "constellation_zneenosec", "constellation_kit"};
