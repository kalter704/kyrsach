...
public class DatasForDB {
    ...
    public String[] constellation_name = {"Персей", "Лев", "Андромеда", "Большая Медведица", "Овен", "Цефей"};
    public int[] constellation_id = {151, 152, 153, 154, 155, 156};
    public String[] constallation_img = {"constellation_persei", "constellation_lev", "constellation_andromeda", "constellation_bolshaya_medved", "constellation_oven", "constellation_cefer"};
    public String[] constellation_where = {
